...
const Sidebar = ({ activeMenu, setActiveMenu }) => {
 return (
  <aside className="sticky top-0 h-screen overflow-hidden border-r border-slate-200/50 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950 px-6 py-8 text-white shadow-2xl">
    ...
    <div className="mt-12 rounded-3xl border border-white/10 bg-gradient-to-br from-white/10 to-white/5 p-5 backdrop-blur-sm">
      ...
      <button className="mt-5 w-full rounded-2xl bg-gradient-to-r from-blue-600 to-purple-600 px-4 py-3 font-semibold text-white transition-all duration-200 hover:scale-105 hover:shadow-lg">
        Add Transaction
      </button>
    </div>
    ...
    <div className="mt-8 rounded-3xl border border-white/10 bg-white/5 p-5 backdrop-blur-sm">
      <div className="flex items-center gap-3">
        <div className="rounded-2xl border border-white/10 bg-gradient-to-br from-blue-500/20 to-purple-500/20 p-2.5">
